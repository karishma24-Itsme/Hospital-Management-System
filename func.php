    ...
    <div class="tab-content" id="nav-tabContent">
            ...
            <div class="card-body">
              ...
              <form class="form-group" method="post" action="appointment.php">
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <input type="submit" name="entry_submit" value="Create new entry" class="btn btn-success" id="inputbtn">
                  </div>
        ...
        <div class="card">
          <div class="card-body">
            <form class="form-group" method="post" action="func.php">
              ...
              <input type="submit" value="update" name="update_data" class="btn btn-success">
            </form>
          </div>
        </div><br><br>
      </div>
      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
        <form class="form-group" method="post" action="func.php">
          ...
          <br>
          <input type="submit" name="doc_sub" value="Add Doctor" class="btn btn-success">
        </form>
      </div>
