...
<html lang="en">
  ...
  <body style="background: -webkit-linear-gradient(left, #094d51, #1bdec4); background-size: cover;">
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">

      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><img src="https://www.shutterstock.com/shutterstock/photos/618531245/display_1500/stock-vector-welcome-medical-service-card-template-physician-in-a-creative-frame-hospital-card-concept-world-618531245.jpg" width="35" height="35"
  style="border-radius:50%;"> &nbsp HEALTHCARE</h4></a>
    ...
    animation: mover 1s infinite alternate;">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQDOAU67z4txr1tyP5l3ZpEzYp8rn6wvdPXsw&s" alt="" style="width: 20%;padding-left: 40px;margin-top: 150px;margin-left: 45px;margin-bottom:15px">
      </div>
