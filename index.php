...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQDOAU67z4txr1tyP5l3ZpEzYp8rn6wvdPXsw&s" alt=""/>
                        <h3>Welcome</h3>
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="submit" class="btnRegister" name="register_submit" onclick="return checklen();" value="Register"/>
