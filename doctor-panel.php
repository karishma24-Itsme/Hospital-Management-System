...
<html lang="en">
  ...
  <style >
    .bg-primary {
    background: -webkit-linear-gradient(left, #036067, #53ecd7);
}
...
.text-primary {
  ...
  <body style="padding-top:50px;">
   ...
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%; padding-bottom: 20px;font-family:'IBM Plex Sans', sans-serif;"> Welcome &nbsp<?php echo $_SESSION['dname']; ?>
      </h3>
    <div class="row">
                  ...
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <p class="links cl-effect-1">
                        <a href="#list-app" data-toggle="list">
                          Appointment List
                        </a>
                      </p>
                    </div>
                ...
                <div class="col-sm-4" style="left: 15%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <p class="links cl-effect-1">
                        <a href="#list-pres" data-toggle="list">Prescription List</a>
                      </p>
                    </div>
                  </div>
                </div>    
                  ...
                  <?php 
                    ...
                    if(($row['userStatus']==1) && ($row['doctorStatus']==0))  
                    {
                     ...
                     <td>
                        ...
                        <button class="btn btn-primary">Prescibe</button></a>
                        <?php } else {
