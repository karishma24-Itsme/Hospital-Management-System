...
function generate_bill(){
  ...
  while($row = mysqli_fetch_array($query)){
    ...
    $output .= '
<center>
<span style="font-size:28px;color:#1a3c6e;"><b>HEALTHCARE</b></span>
<span style="font-size:14px;"><br>
Address: Sector 10, Kalamboli, Navi Mumbai<br>
...
<tr>
<td width="50%">
<b style="color:#1a3c6e;">Patient Information</b><br><br>
...
<td width="50%">
<b style="color:#1a3c6e;">Doctor Information</b><br><br>
'.$row["doctor"].'<br>
Date: '.$row["appdate"].'<br>
Time: '.$row["apptime"].'
</td>
...
<tr>
<td style="background-color:#1a3c6e;color:white;"><b>INVOICE NUMBER</b></td>
<td style="background-color:#1a3c6e;color:white;"><b>DATE</b></td>
<td style="background-color:#1a3c6e;color:white;"><b>APPOINTMENT ID</b></td>
<td style="background-color:#1a3c6e;color:white;"><b>PRICE</b></td>
</tr>
...
<table border="1" cellpadding="10">
<tr>
<td style="background-color:#1a3c6e;color:white;"><b>SERVICE</b></td>
<td style="background-color:#1a3c6e;color:white;"><b>DESCRIPTION</b></td>
<td style="background-color:#1a3c6e;color:white;"><b>PRICE</b></td>
</tr>
...
<tr>
<td>
<b style="color:#1a3c6e;">Notes:</b><br>
Take medicines on time and follow doctor advice.
</td>
</tr>
</table>
<br><br>
...
<img src="'.$_SERVER['DOCUMENT_ROOT'].'/myhms1/images/sign.png" width="120"><br>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><img src="https://www.shutterstock.com/shutterstock/photos/618531245/display_1500/stock-vector-welcome-medical-service-card-template-physician-in-a-creative-frame-hospital-card-concept-world-618531245.jpg" width="35" height="35"
  style="border-radius:50%;">  HEALTHCARE </a>
  ...
  <style >
    .bg-primary {
    background: -webkit-linear-gradient(left, #046861, #42f8f2);
}
...
if(!$con){
  ...
  var fees = this.options[this.selectedIndex].getAttribute('data-value');
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <!-- <a href="admin-panel.php?ID=" 
                              onClick=""
                              title="Pay Bill" tooltip-placement="top" tooltip="Remove"><button class="btn btn-primary">Pay</button>
                              </a></td> -->

                              <a href="admin-panel.php?ID=<?php echo $row['ID']?>">
                              <input type ="hidden" name="ID" value="<?php echo $row['ID']?>"/>
                              <input type = "submit" onclick="alert('Bill Paid Successfully');" name ="generate_bill" class = "btn btn-primary" value="Pay Bill"/>
                              </a>
                              </td>
                              </form>
